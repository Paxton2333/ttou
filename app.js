document.addEventListener('DOMContentLoaded', () => {
    ...
    const albumSongs = {
        1: [
            { title: 'A Stand that Existed', artist: 'TToU', url: 'https://example.com/A_Stand_that_Existed.mp3' },
            { title: 'Allocation Task Force', artist: 'TToU', url: 'https://example.com/Allocation_Task_Force.mp3' },
            { title: 'Alternates', artist: 'TToU', url: 'https://example.com/Alternates.mp3' },
            { title: 'Andr', artist: 'TToU', url: 'https://example.com/Andr.mp3' },
            { title: 'Anywhere in The Universe', artist: 'TToU', url: 'https://example.com/Anywhere_in_The_Universe.mp3' },
            { title: 'Average Alternate', artist: 'TToU', url: 'https://example.com/Average_Alternate.mp3' },
            { title: 'Casual', artist: 'TToU', url: 'https://example.com/Casual.mp3' },
            { title: 'Core of The Universe and All Knowledge', artist: 'TToU', url: 'https://example.com/Core_of_The_Universe_and_All_Knowledge.mp3' },
            { title: 'Cyber Trap', artist: 'TToU', url: 'https://example.com/Cyber_Trap.mp3' },
            { title: 'Der Teemeister aus der Leere', artist: 'TToU', url: 'https://example.com/Der_Teemeister_aus_der_Leere.mp3' },
            { title: 'Futuristic World', artist: 'TToU', url: 'https://example.com/Futuristic_World.mp3' },
            { title: 'G Foundation', artist: 'TToU', url: 'https://example.com/G_Foundation.mp3' },
            { title: 'G-033', artist: 'TToU', url: 'https://example.com/G-033.mp3' },
            { title: 'G-Adv', artist: 'TToU', url: 'https://example.com/G-Adv.mp3' },
            { title: 'Guardian of the Cosmos', artist: 'TToU', url: 'https://example.com/Guardian_of_the_Cosmos.mp3' },
            { title: 'H0RR0R', artist: 'TToU', url: 'https://example.com/H0RR0R.mp3' },
            { title: 'Holyght', artist: 'TToU', url: 'https://example.com/Holyght.mp3' },
            { title: 'I can see', artist: 'TToU', url: 'https://example.com/I_can_see.mp3' }
        ]
    };
