...
const albumSongs = {
    1: [
        { title: 'A Stand that Existed', artist: 'TToU', url: 'files/A%20Stand%20that%20Existed.mp3' },
        { title: 'Allocation Task Force', artist: 'TToU', url: 'files/Allocation%20Task%20Force.mp3' },
        { title: 'Alternates', artist: 'TToU', url: 'files/Alternates.mp3' },
        { title: 'Andr', artist: 'TToU', url: 'files/Andr.mp3' },
        { title: 'Anywhere in The Universe', artist: 'TToU', url: 'files/Anywhere%20in%20The%20Universe.mp3' },
        { title: 'Average Alternate', artist: 'TToU', url: 'files/Average%20Alternate.mp3' },
        { title: 'Casual', artist: 'TToU', url: 'files/Casual.mp3' },
        { title: 'Core of The Universe and All Knowledge', artist: 'TToU', url: 'files/Core%20of%20The%20Universe%20and%20All%20Knowledge.mp3' },
        { title: 'Cyber Trap', artist: 'TToU', url: 'files/Cyber%20Trap.mp3' },
        { title: 'Der Teemeister aus der Leere', artist: 'TToU', url: 'files/Der%20Teemeister%20aus%20der%20Leere.mp3' },
        { title: 'Futuristic World', artist: 'TToU', url: 'files/Futuristic%20World.mp3' },
        { title: 'G Foundation', artist: 'TToU', url: 'files/G%20Foundation.mp3' },
        { title: 'G-033', artist: 'TToU', url: 'files/G-033.mp3' },
        { title: 'G-Adv', artist: 'TToU', url: 'files/G-Adv.mp3' },
        { title: 'Guardian of the Cosmos', artist: 'TToU', url: 'files/Guardian%20of%20the%20Cosmos.mp3' },
        { title: 'H0RR0R', artist: 'TToU', url: 'files/H0RR0R.mp3' },
        { title: 'Holyght', artist: 'TToU', url: 'files/Holyght.mp3' },
        { title: 'I can see', artist: 'TToU', url: 'files/I%20can%20see.mp3' }
    ]
};
